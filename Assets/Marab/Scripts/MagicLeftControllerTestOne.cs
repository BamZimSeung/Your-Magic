...
public class MagicLeftControllerTestOne : MagicControllerTestOne
{
    ...
    override public void MagicScaleChange(DIR dir)
    {
        ...
        {
            case DIR.UP:
                thumDir = OVRInput.Button.PrimaryThumbstickUp;
                break;
            case DIR.RIGHT:
                thumDir = OVRInput.Button.PrimaryThumbstickRight;
                break;
            case DIR.DOWN:
                thumDir = OVRInput.Button.PrimaryThumbstickDown;
                break;
            case DIR.LEFT:
                thumDir = OVRInput.Button.PrimaryThumbstickLeft;
                break;
            default:
                thumDir = OVRInput.Button.PrimaryThumbstick;
                break;
        }
    ...
    override public DIR ChoiceWhat()
    {
        ...
        if (OVRInput.Get(OVRInput.Button.PrimaryThumbstickUp, touch))
        {
            return DIR.UP;
        }
        else if (OVRInput.Get(OVRInput.Button.PrimaryThumbstickDown, touch))
        {
            return DIR.DOWN;
        }
        else if(OVRInput.Get(OVRInput.Button.PrimaryThumbstickLeft, touch))
        {
            return DIR.LEFT;
        }
